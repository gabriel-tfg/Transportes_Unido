...
public class Chart: Control {
    ...
    private void DrawLegends()
    {
        ...
        this.DrawString(
                ...
                (int) ( this.FramedEndPosition.Y) +25,
                this.LegendX,
                vertical: false );
        ...
        this.DrawString(
                ...
                (int) this.FramedOrgPosition.X - 30,
                this.LegendY,
                vertical: true );
    }
    ...
    private void DrawData()
    {
        ...
        for(int i = 0; i < numValues; ++i) {
            ...
            this.DrawString(
                        ...
                        x: (int) ( nextPoint.X - ( this.DataPen.Thickness / 2 ) +7 ),
                        y: (int) ( nextPoint.Y - this.DataPen.Thickness+3 ),
                        msg: tag );
    ...
    private void DrawAxis()
    {
            ...
            for (int i = 0; i < ( numValues + 1 ); ++i) {
                  ...
                  && ( i - 1 ) < this._labels.Count )
                {
                    this.DrawString(
                        ...
                        this.LegendBrush,
                        x: columnPos,
                        y: (int) ( this.FramedEndPosition.Y + 8 ),
        ...
        this.DrawLine( this.AxisPen,
                       ...
                       (int) this.FramedOrgPosition.Y+7,
                       (int) this.FramedOrgPosition.X,
                       (int) this.FramedEndPosition.Y +7);
